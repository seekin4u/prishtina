/obj/item/organ
	...
	var/list/cyber_modules = list()
	var/space_for_modules = 10
...
/obj/item/organ/proc/get_external()
	return owner.organs_by_name[parent_organ]

/obj/item/organ/proc/get_free_space()
	var/total_size = 0
	for(var/obj/item/cyber/c in cyber_modules)
		total_size += c.size

	return max(0, space_for_modules - total_size)