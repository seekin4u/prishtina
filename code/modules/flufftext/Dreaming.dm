...
*/
var/list/dreams = list(
	"a gun", "a rifle", "a Russia", "a USA", "democracy", "freedom", "flags", "girls", "dickgirls", "the cold", "the heat", "wind",
	"a cigarette", "light", "the sun", "future", "money", "the mother", "the father", "glory", "pride",
	"water", "ocean", "the home city", "the country", "the meaning of war", "the army", "friends",
	"comrades", "cowards", "blood", "harm", "pain", "the Slatino", "planes", "tushenka", "sguschenka",
	"weather", "ships", "the commander", "cars", "rivers", "grass", "forest", "sand"
	)
