...
/datum/species/proc/create_organs(var/mob/living/carbon/human/H) //Handles creation of mob organs.
	...
	//Carefully remove all our cyber modules
	...
	//And now let's install them back
	for(var/obj/item/cyber/C in modules)
		if(!C.last_location_name)
			continue
		for(var/obj/item/organ/O in H.organs)
			if(O.name == C.last_location_name)
				C.install(O, H)
				break
