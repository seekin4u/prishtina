...
/mob/proc/get_active_hand()
	if(hand == R_HAND)	return r_hand
	if(hand == L_HAND)	return l_hand
	return null

//Returns the thing in our inactive hand
/mob/proc/get_inactive_hand()
	if(hand == R_HAND)	return l_hand
	if(hand == L_HAND)	return r_hand
	return null
...
/mob/proc/put_in_active_hand(var/obj/item/W)
	if(hand == R_HAND)	return put_in_r_hand(W)
	if(hand == L_HAND)	return put_in_l_hand(W)
	return 0

//Puts the item into our inactive hand if possible. returns 1 on success.
/mob/proc/put_in_inactive_hand(var/obj/item/W)
	if(hand == R_HAND)	return put_in_l_hand(W)
	if(hand == L_HAND)	return put_in_r_hand(W)
	return 0
