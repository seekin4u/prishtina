...
/obj/item/clothing/suit/verb/rip_left_sleeve()
	set category = "Object"
	set name = "Rip Left Sleeve"
	set src in usr.contents

	rip_clothes(LEFT_SLEEVE)

/obj/item/clothing/suit/verb/rip_right_sleeve()
	set category = "Object"
	set name = "Rip Right Sleeve"
	set src in usr.contents

	rip_clothes(RIGHT_SLEEVE)
...
/obj/item/clothing/pants
	icon = 'icons/CyberpunkBeta/Stanishki.dmi'
	w_class = 4.0
	throwforce = 2
	slot_flags = SLOT_ICLOTHING
