...
//	/client/proc/change_human_appearance_self,	/* Allows the human-based mob itself change its basic appearance */
	...
	/client/proc/allow_join_enforce,
...
/client/proc/allow_join_enforce()
	...
	set name = "Toggle join EnForce"

	ticker.can_latejoin_enforce = !ticker.can_latejoin_enforce
	world << "<font color=blue>Now you [(ticker.can_latejoin_enforce) ? "can" : "can't"] join EnForce.</font>"

/client/proc/allow_join_ruforce()
	set category = "Prishtina"
	set name = "Toggle join RuForce"

	ticker.can_latejoin_ruforce = !ticker.can_latejoin_ruforce
	world << "<font color=red>Now you [(ticker.can_latejoin_ruforce) ? "can" : "can't"] join RuForce.</font>"
...
/client/proc/toggle_autobalance()
	...
	world << "<font size=3>Autobalance was [(job_master.autobalance) ? "enabled" : "disabled"].</font>"
...
/client/proc/show_battle_report()
	...
	usr << "EnForce: [alive_en] alive and [heavily_injured_en] heavily injured."
	usr << "RuForce: [alive_ru] alive and [heavily_injured_ru] heavily injured."
	...
	if(public == "Yes")
		...
		world << "<font size=3>EnForce: [alive_en] alive and [heavily_injured_en] heavily injured.</font>"
		world << "<font size=3>RuForce: [alive_ru] alive and [heavily_injured_ru] heavily injured.</font>"
