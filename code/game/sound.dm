...
var/list/concrete_step_sound = list('sound/effects/footsteps/concrete1.ogg', 'sound/effects/footsteps/concrete2.ogg', 'sound/effects/footsteps/concrete3.ogg', 'sound/effects/footsteps/concrete4.ogg')
var/list/grass_step_sound = list('sound/effects/footsteps/grass1.ogg', 'sound/effects/footsteps/grass2.ogg', 'sound/effects/footsteps/grass3.ogg', 'sound/effects/footsteps/grass4.ogg', 'sound/effects/footsteps/grass5.ogg')
var/list/dirt_step_sound = list('sound/effects/footsteps/dirt1.ogg', 'sound/effects/footsteps/dirt2.ogg')
var/list/wood_step_sound = list('sound/effects/footsteps/wood1.ogg', 'sound/effects/footsteps/wood2.ogg', 'sound/effects/footsteps/wood3.ogg')
...
/client/proc/playtitlemusic()
	...
	if(prefs.toggles & SOUND_LOBBY)
		src << sound(ticker.login_music, repeat = 1, wait = 0, volume = 60, channel = 1)
...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			if ("dirt") soundin = pick(dirt_step_sound)
			if ("concrete") soundin = pick(concrete_step_sound)
			if ("grass") soundin = pick(grass_step_sound)
