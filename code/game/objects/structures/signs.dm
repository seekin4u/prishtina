...
/obj/structure/sign/portrait_miloshevich
	name = "\improper Miloshevch's portrait."
	desc = "Looks proud for the country but look what is happening now!"
	icon_state = "miloshevich"

/obj/structure/sign/portrait_eltsin
	name = "\improper Eltsin's portrait."
	desc = "Leader tell us why we are fighting?"
	icon_state = "eltsin"
