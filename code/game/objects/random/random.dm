...
/obj/random/revolver
	...
	item_to_spawn()
		return pick(/obj/item/weapon/gun/projectile/revolver,
...
/obj/random/flower
	...
	item_to_spawn()
		return pick(/obj/structure/flora/ausbushes/ywflowers,
...
/obj/random/grass
	...
	item_to_spawn()
		return pick(/obj/structure/flora/ausbushes/sparsegrass,
...
/obj/random/bush
	...
	item_to_spawn()
		return pick(/obj/structure/flora/ausbushes,
