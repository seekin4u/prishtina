...
/obj/item/weapon/storage/box/tear_grenades
	name = "box of tear grenades"
	icon_state = "flashbang"

/obj/item/weapon/storage/box/tear_grenades/New()
	..()
	for(var/i = 0; i < 7; i++)
		new /obj/item/ammo_casing/grenade/tear(src)
