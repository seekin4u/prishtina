...
/obj/effect/effect/smoke/tear
	name = "tear gas"
	icon_state = "mustard"

/obj/effect/effect/smoke/tear/Move()
	..()
	for(var/mob/living/carbon/human/R in get_turf(src))
		affect(R)

/obj/effect/effect/smoke/tear/affect(var/mob/living/carbon/human/R)
	if (!..())
		return 0
...
/datum/effect/effect/system/smoke_spread/tear
	smoke_type = /obj/effect/effect/smoke/tear
