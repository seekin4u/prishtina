...
/*
	...
	MS.warmup_time = 20
	MS.cooldown = 60
	MS.origin = locate(/area/shuttle/helicopter/nato_base)
	MS.start_location = "NATO Base"
	MS.destinations = list(
		"Northwest Landing Site" = locate(/area/shuttle/helicopter/landing_site_nw),
		"Southwest Landing Site" = locate(/area/shuttle/helicopter/landing_site_sw),
		"Southeast Landing Site" = locate(/area/shuttle/helicopter/landing_site_se),
		)

	MS.announcer = "Internal Feelings"
	MS.arrival_message = "You are hearing a sound of an approaching helicopter."
	MS.departure_message = "You are hearing a sound of a receding helicopter."

	shuttles["Helicopter"] = MS
	process_shuttles += MS
*/
